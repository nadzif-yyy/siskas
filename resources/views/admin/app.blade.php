...
<head>
    ...
    <title>Sahabat Yatim - Admin</title>
</head>
<body>
    @if (Route::has('login'))
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Asrama</h6>
                        <a class="collapse-item" href="{{ route('data-asrama.index') }}">Data Asrama</a>
                    </div>
                </div>
            </li>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form action="#" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" name="search" id="search" placeholder="Search for..."
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                    @auth
                                        ...
                                        <a href="{{ route('welcome') }}" class="dropdown-item text-center">
                                            FE
                                        </a>
                                    @endauth
                                </div>
